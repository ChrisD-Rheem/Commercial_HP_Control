...
def hp_ODFan2(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-225 - Variable Speed Outdoor Fan Motor #2
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the Variable Speed Outdoor Fan Motor #2 labeled "VSODF2"
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_ODFan2, name=TEST_CASE_NAME,
