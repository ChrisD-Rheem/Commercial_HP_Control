...
def hp_cds(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_cds, name=TEST_CASE_NAME,
