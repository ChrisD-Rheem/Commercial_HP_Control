...
def tc_thermo(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-214 - Thermostat
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the 24V thermostat.
