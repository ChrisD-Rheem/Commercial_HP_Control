...
def tc_xxxx(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    ...
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the Smoke Detector.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_smoke, name=TEST_CASE_NAME,
