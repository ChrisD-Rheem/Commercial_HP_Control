...
def hp_PhaseMon(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-222 - Phase Monitoring (Standard) & Comfort Alert Modules (Optional)
 
    Test Case Purpose:
        The purpose of this test case is to test the funcionality of the phase monitoring and comfort alert modules.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_PhaseMon, name=TEST_CASE_NAME,
