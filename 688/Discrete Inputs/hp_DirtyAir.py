...
def hp_DirtyAir(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-220 - Dirty Air / Clogged Filter Switch
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the Dirty Air / Clogged Filter Switch.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_DirtyAir, name=TEST_CASE_NAME,
