...
def hp_amb(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-221 - Low Ambient Control
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the Low Ambient Control, labeled Outdoor Fan Refrigerant Pressure Switch "REFP".
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_amb, name=TEST_CASE_NAME,
