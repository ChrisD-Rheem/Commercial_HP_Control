...
def hp_A2L(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-219
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the A2L Refrigerant Sensor.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_A2L, name=TEST_CASE_NAME,
