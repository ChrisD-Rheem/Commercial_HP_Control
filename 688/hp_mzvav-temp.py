...
TEST_CASE_NAME = "hp_mzvavtemp.py"
...
def hp_mzvavtemp(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_mzvavtemp, name=TEST_CASE_NAME,
