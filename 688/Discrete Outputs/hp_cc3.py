...
TEST_CASE_NAME = "hp_cc3"
TEST_CASE_VERSION = "01.00.00"
 
#use the first def in case of prompt user needed
#def hp_cc3(bench_test, log_config, cmd_msg_que, response_que, econet_write_obj_que, econet_read_obj_que, kill_que, prompt_que):
def hp_cc3(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-241 - Compressor Output 3 CC3
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the CC3 output.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_cc3, name=TEST_CASE_NAME,
