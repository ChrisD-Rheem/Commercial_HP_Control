...
TEST_CASE_NAME = "hp_w1"
TEST_CASE_VERSION = "01.00.00"
 
#use the first def in case of prompt user needed
#def hp_w1(bench_test, log_config, cmd_msg_que, response_que, econet_write_obj_que, econet_read_obj_que, kill_que, prompt_que):
def hp_w1(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-229 - Electric Heat Output W1
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the W1 output.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_w1, name=TEST_CASE_NAME,
