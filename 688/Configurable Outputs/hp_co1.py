...
def hp_co1(bench_test, log_config, log_lock, response_que, econet_write_obj_que, econet_read_obj_que, kill_que):
    """
     Test Case Requirement:
    ACHPC-SR-239 - Configurable Output #1 (Optional)
 
    Test Case Purpose:
        The purpose of this test case is to test the functionality of the Configurable Output #1.
...
def main(bench_test = False):
    ...
    try:
        ...
        test_case_proc = Process(target=hp_co1, name=TEST_CASE_NAME,
